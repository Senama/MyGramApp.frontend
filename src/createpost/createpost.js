                                                ...
                                                <div className='mx-auto d-block' style={{ 'maxWidth': '350px' }}>
                                                    <Card>
                                                        <CardHeader style={{ backgroundColor: '#ffe599' }}>
                                                            ...
                                                            <Link to='/login' >
                                                                <img style={{ 'float': 'right' }} className='style' src={require('../Logoutbutton.png')} alt='' onClick={this.loggedOut}></img>
                                                            </Link>
                                                        ...
                                                        <CardBody>
                                                            ...
                                                            <div className='buttons text-center' style={{ 'paddingTop': '100px', 'paddingBottom': '30px' }}>
                                                                <Link to='/userprofile' >
                                                                    <Button onClick={this.handleSubmit} color='danger' size='lg'>POST</Button>
                                                                </Link>
                                                            </div>
                                                        </CardBody>
                                                    </Card>
